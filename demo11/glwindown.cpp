...
void QLWindown::paintGL(){
    ...
    glBegin(GL_POLYGON);
    glColor4ub(255,0,0,255); glVertex3f(-0.5f, -0.25f, -2.5);
    glColor4ub(0,0,255,255); glVertex3f(0.25f, -0.25f, -2.5);
    glColor4ub(0,255,0,255); glVertex3f(1.0f, 0.5f, -2.5);
    glColor4ub(255,0,0,255); glVertex3f(0.5f, 0.5f, -2.5);
    glColor4ub(0,255,0,255); glVertex3f(0.0f, 0.25f, -2.5);
    glEnd();
}
