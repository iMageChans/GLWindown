...
void QLWindown::paintGL(){
    ...
    glColor4ub(255,0,0,255);glVertex3f(-0.5f - 1.0f,-0.25f,-5.0f);
    glColor4ub(0,0,255,255);glVertex3f(0.5f - 1.0f,-0.25f,-5.0f);
    glColor4ub(0,255,0,255);glVertex3f(0.0f - 1.0f,0.5f,-5.0f);
    glEnd();
